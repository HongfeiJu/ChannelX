...
import ChannelDataGetter from "../../services/ChannelDataGetter";
                ...
                .then(snapshot => {
                    snapshot
                        ...
                        .forEach(doc => {
                            ...
                            // password = ChannelDataGetter.getPublicChannelPassword(doc.id);
                            // console.log("ChannelDataGetter:" , password);
